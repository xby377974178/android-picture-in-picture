...
//        String assetsFilePath = null , destFilePath = null;
//        ResourceUtils.copyFileFromAssets(this, assetsFilePath, destFilePath);
    }
    ...
    private void initView() {
        ...
        mEditInputRoomId.setText("1001");
        String time = String.valueOf(System.currentTimeMillis());
        String userId = time.substring(time.length() - 8);
        mEditInputUserId.setText("1001");
    }
    ...
    private void startEnterRoom() {
        ...
        if (mRoleSelectFlag == 1) {
            ...
            Intent intent = new Intent(LiveEnterActivity.this, FloatingWindowActivity.class);
