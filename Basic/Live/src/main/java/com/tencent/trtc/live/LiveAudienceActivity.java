...
//        mTRTCParams.strRoomId = mRoomId;
        ...
        mTRTCCloud.setRemoteVideoRenderListener(" ", 1, 1, new TRTCCloudListener.TRTCVideoRenderListener() {
            @Override
    ...
    protected class TRTCCloudImplListener extends TRTCCloudListener {
        ...
        public void onUserVideoAvailable(String userId, boolean available) {
            ...
            if (available) {
                ...
                mTRTCCloud.setRemoteRenderParams(mRemoteUserId , TRTCCloudDef.TRTC_VIDEO_STREAM_TYPE_BIG, params);
